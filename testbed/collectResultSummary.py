...
listFile = r'C:\Users\Leo\Documents\My DBank\Carnegie Speech\javaworkspacedell\NoiseTest\fileidlist.txt'
...
for scene in scene_list:    
    ...
    for ln in lines:
        ...
        print resFile
        phoneme_count, ok_count, soso_count, bad_count,unknow_count = processAAResult.getPhCount(resFile)
